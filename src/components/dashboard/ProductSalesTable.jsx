...
function EditableTableRow({ rowData, onCancelEdit, isEditing, onStartEdit }) {
  ...
  return (
    <>
      ...
      >
        <TableCell>
          {new Date(rowData.sale_date).toLocaleDateString()}
        </TableCell>
        ...
        <TableCell align="right">
          {formatCurrency(rowData.final_total)}
        </TableCell>
        <TableCell align="center">
          {isLoading ? (
            <CircularProgress size={24} />
            ...
            <>
              <IconButton onClick={() => onStartEdit(rowData)}>
                <Edit />
              </IconButton>
              <IconButton
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            ...
            {rowData.product_name}"? This action cannot be undone.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
